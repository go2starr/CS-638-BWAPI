...
const char* UnitTypeStrings[] = {
    ...
    "Powerup_Mineral_Cluster_Type",
    "Powerup_Mineral_Cluster_Type",
    "Powerup_Protoss_Gas_Orb_Type",
    "Powerup_Protoss_Gas_Orb_Type",
    "Powerup_Zerg_Gas_Sac_Type",
    "Powerup_Zerg_Gas_Sac_Type",
    "Powerup_Terran_Gas_Tank_Type",
    "Powerup_Terran_Gas_Tank_Type",
    "None",
    "AllUnits",
    "Men",
